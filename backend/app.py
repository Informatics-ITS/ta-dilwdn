...
def solve_text():
    ...
    needs_gemini_analysis = (
        ...
        result.get("operator", "").lower() in ["unknown", "mixed", "complex"] or
        result.get("operator") not in ["Penjumlahan", "Pengurangan", "Perkalian", "Pembagian"]
    )

    print(needs_gemini_analysis)
...
def solve_text_internal(text_input):
    ...
    needs_gemini_analysis = (
        (result.get("operator") in ["Tidak diketahui", "Mix", "Campuran"] or
        result.get("operator", "").lower() in ["unknown", "mixed", "complex"]) and
        result.get("operator") not in ["Penjumlahan", "Pengurangan", "Perkalian", "Pembagian"]
    )
